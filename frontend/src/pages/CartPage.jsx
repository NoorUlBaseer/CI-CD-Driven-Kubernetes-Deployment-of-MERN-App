  ...
  return (
    <div className="py-8">
      <div className="container-custom mx-auto px-4">
        <h1 className="text-2xl md:text-3xl font-bold text-neutral-900 mb-6">Your Shopping Cart</h1>
        ...
        {cartItems.length === 0 ? (
          <div className="bg-white p-8 rounded-xl shadow-sm text-center">
            ...
            <h2 className="mt-4 text-lg font-medium text-neutral-800">Your cart is empty</h2>
            <p className="mt-2 text-neutral-600">Looks like you haven't added anything to your cart yet.</p>
                          ...
                          <div className="flex justify-between">
                            <div>
                              <h3 className="text-base font-medium text-neutral-900">
                                <Link to={`/products/${item._id}`} className="hover:text-primary-600">
                                  {item.name}
                                </Link>
                              </h3>
                              <p className="mt-1 text-sm text-neutral-500">{item.category}</p>
                            </div>
                            <p className="text-base font-medium text-neutral-900">${(item.price * item.quantity).toFixed(2)}</p>
                          </div>
