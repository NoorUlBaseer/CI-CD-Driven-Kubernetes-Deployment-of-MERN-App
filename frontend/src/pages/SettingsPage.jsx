                        ...
                        <tr key={product._id}>
                          <td className="px-6 py-4 whitespace-nowrap">
                            <div className="flex items-center">
                              <div className="h-10 w-10 flex-shrink-0 rounded-md bg-neutral-100 overflow-hidden">
                                {product.image ? (
                                  <img
                                    ...
                                    onError={(e) => {
                                      ...
                                      e.target.parentElement.innerHTML =
                                        '<div class="flex items-center justify-center h-full"><div class="text-neutral-400 text-[10px]">No Image</div></div>';
                                    }}
                                  />
                                ) : (
