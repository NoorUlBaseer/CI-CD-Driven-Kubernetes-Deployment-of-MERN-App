    ...
    <footer className="bg-white border-t border-neutral-200">
      <div className="container-custom mx-auto py-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            <Link to="/" className="text-xl font-bold text-primary-600">ShopEase</Link>
          ...
          <div>
            <h3 className="text-sm font-semibold text-neutral-900 uppercase tracking-wider">Quick Links</h3>
            <ul className="mt-4 space-y-2">
              ...
              <li>
                <Link to="/cart" className="text-neutral-600 hover:text-primary-600 transition-colors">
                  Cart
                </Link>
              </li>
            </ul>
